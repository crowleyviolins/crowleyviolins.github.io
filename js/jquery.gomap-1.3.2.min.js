...
jQuery(document).ready(function() {
	// initiate googlemaps					
    jQuery('#map').goMap({ address: '1476 River Street, Boston, MA, USA',
	    	zoom: 14,
	    	...
	    	markers: [
	    		{ 'address' : '1476 River Street, Boston, MA, USA' }
	    	],
...
var styles = [ { "stylers": [ { "visibility": "on" }, { "saturation": -100 }, { "gamma": 1 } ] },{ } ];
    ...
    mapTypeControlOptions: {
       mapTypeIds: [google.maps.MapTypeId.ROADMAP, 'Anchor']
    }});
    ...
    $.goMap.map.mapTypes.set('Anchor', jayzMapType);
    $.goMap.map.setMapTypeId('Anchor');
